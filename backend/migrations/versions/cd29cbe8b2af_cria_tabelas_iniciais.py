...
Revision ID: cd29cbe8b2af
Revises: 
Create Date: 2026-02-08 06:11:48.685193
...
def upgrade():
    ...
    sa.Column('categoria', sa.Enum('preventiva', 'defeito', name='categoria', native_enum=False), nullable=False),
    ...
    sa.Column('status', sa.Enum('pendente', 'em_andamento', 'concluido', name='statustarefa', native_enum=False), nullable=False),
    sa.ForeignKeyConstraint(['prestador_id'], ['usuarios.id'], ),
